    ...
    for hallucinations in ['intrinsic_hallucinations', 'extrinsic_hallucinations', 'all_hallucinations']:
        ...
        for pid, prediction in predictions.items():
            ...
            preds = [max(l1, l2) for l1, l2 in zip(
                flatten(prediction['intrinsic_hallucination_probs']),
                flatten(prediction['extrinsic_hallucination_probs']),
            )]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--predictions_path', default='results/frank/feqa_predictions.jsonl')
    parser.add_argument('--output_path', default='results/frank/feqa_results.json')
