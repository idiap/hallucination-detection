...
if __name__ == '__main__':
    ...
    parser.add_argument('--predictions_path', default='results/frank/dae_predictions.jsonl')
    parser.add_argument('--output_path', default='results/frank/dae_results.json')
